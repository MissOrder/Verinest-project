      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 overflow-y-auto p-4 lg:p-6 space-y-6">
          ...
          <div className="bg-[#113c5e] text-white p-6 rounded-2xl">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-3xl font-bold">{totalRewards()} VTS</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Streak Rewards Card */}
            <div className="p-6 bg-white rounded-2xl shadow-sm">
              <h2 className="text-lg font-medium text-slate-800 mb-4">Daily Login Rewards</h2>
              <div className="grid grid-cols-7 gap-2 mb-4">
                {[1, 2, 3, 4, 5, 6, 7].map(day => (
                  <div key={day} className={`flex flex-col items-center p-2 rounded-lg ${day <= currentStreak ? 'bg-green-100' : 'bg-slate-100'}`}>
                    <span className="text-sm font-medium">Day {day}</span>
                    <span className="text-xs">{calculateReward(day)} VTS</span>
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center mt-1 ${day <= currentStreak ? 'bg-green-500 text-white' : 'bg-slate-300'}`}>
              ...
              <p className="text-sm text-slate-600">
                Login consecutively to claim higher rewards. Current bonus: {calculateReward(currentStreak)} VTS
              </p>
            </div>
          </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 rounded-lg bg-slate-50 gap-2 sm:gap-0">
                <div className="flex-1">
                  ...
                  <p className="text-slate-500 text-xs mt-1">Earn 5 VTS for engaging with our community</p>
                </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 rounded-lg bg-slate-50 gap-2 sm:gap-0">
                <div className="flex-1 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-xs mt-1">Test your knowledge and earn 10 VTS</p>
                  </div>
                </div>
                <button className="bg-blue-100 text-blue-700 hover:bg-blue-200 px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap flex items-center gap-1">
                  Start <span>→</span>
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-800">Daily Login Reward</p>
                    <p className="text-xs text-slate-500">Streak day {currentStreak}</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium text-green-600">+{calculateReward(currentStreak)} VTS</p>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Twitter Engagement</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium text-green-600">+5 VTS</p>
